...
<style>
    ...
    .fe-gallery-airbnb .main-img { grid-column: 1; grid-row: 1 / span 2; }
    ...
    [dir="rtl"] .fe-gallery-overlay-badge { right: auto; left: 20px; }
    ...
    .fe-details-tabs::-webkit-scrollbar { display: none; }
    .fe-details-tabs { -ms-overflow-style: none; scrollbar-width: none; }
    ...
    .fe-itinerary-timeline { position: relative; padding-inline-start: 10px; }
    .fe-itinerary-item {
        position: relative;
        padding-bottom: 30px;
    ...
    .badge-gold { background: #e0f2fe; color: #0369a1; border: 1px solid #bae6fd; }
    .badge-economy { background: #f1f5f9; color: #475569; border: 1px solid #e2e8f0; }
    ...
    .fe-pkg-card.active::before {
        ...
        position: absolute; top: 18px; right: 18px; font-size: 1.35rem;
        transition: all 0.3s ease;
    }
    .fe-pkg-card.active[data-tier="vip"]::before { color: #d97706; }
    .fe-pkg-card.active[data-tier="gold"]::before { color: #0284c7; }
    .fe-pkg-card.active[data-tier="economy"]::before { color: #475569; }
    [dir="rtl"] .fe-pkg-card.active::before { left: 18px; right: auto; }
