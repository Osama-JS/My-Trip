...
@section('content')
    ...
    <section class="fe-flights-hero">
        ...
        <div class="fe-container">
            <div class="fe-hero-content-v2">
                ...
                <p class="fe-hero-desc-v2">
                    {{ __('Compare thousands of flights and find the best deals for your next adventure.') }}
                </p>
            </div>
                    ...
                    <div class="fe-search-row-v2">
                        ...
                        <div class="fe-input-group-v2 border-start">
                            <div class="fe-input-sub">
                                ...
                                <div class="date-input-wrapper">
                                    ...
                                    <input type="text" name="departDate" id="departDate" class="fe-ghost-input datepicker"
                        ...
                        <div class="fe-input-group-v2 border-start return-date-group" style="display: none;">
                            <div class="fe-input-sub">
                                ...
                                <div class="date-input-wrapper">
                                    <i class="far fa-calendar-alt"></i>
                                    <input type="text" name="returnDate" id="returnDate" class="fe-ghost-input datepicker"
                                        placeholder="{{ __('Add Return') }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="fe-pax-popover" id="paxPopover">
                                ...
                                <div class="pax-class-select">
                                    ...
                                    <div class="class-options">
                                        <button type="button" class="class-opt active"
                                            data-class="Economy">{{ __('Economy') }}</button>
                                        <button type="button" class="class-opt"
                                            data-class="Business">{{ __('Business') }}</button>
                                        <button type="button" class="class-opt"
                                            data-class="First">{{ __('First') }}</button>
                                    </div>
                                </div>
                                <div class="pax-footer">
                                    <button type="button" id="paxApply"
                                        class="fe-btn fe-btn-primary fe-btn-sm w-full">{{ __('Done') }}</button>
                                </div>
                            </div>
                        </div>
    ...
    <div class="fe-container">
        ...
        <div id="flightResults" class="fe-results-section">
            <div class="fe-empty-state">
                ...
                <p style="color:var(--gray-400);font-size:1.1rem">
                    {{ __('Enter your travel details above to search for available flights.') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="fe-container">
        ...
        <div id="howItWorks" style="padding:var(--space-10) 0 var(--space-16)">
            <h2 style="text-align:center;font-size:1.5rem;font-weight:800;margin-bottom:var(--space-8)">
                {{ __('How Flight Booking Works') }}
            </h2>
            <div class="fe-features-grid">
                <div class="fe-feature-card">
                    ...
                    <p class="fe-feature-desc">{{ __('Enter your departure and destination cities with travel dates.') }}
                    </p>
                </div>
                <div class="fe-feature-card">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
            ...
            return `
                <div class="fr-mobile-bar">
                    <p class="text-muted" style="font-size:0.9rem; margin:0;">
                        <span id="frCountBadge">...</span> {{ __('flights found') }}
                    </p>
                    <button onclick="openFrSidebar()" class="fe-btn fe-btn-primary fe-btn-sm">
                        <i class="fas fa-sliders-h"></i> {{ __('Filters') }}
                    </button>
                </div>
                <div class="fr-flights-overlay" id="frOverlay" onclick="closeFrSidebar()"></div>
                <div class="fr-layout">
                    <aside class="fr-sidebar" id="frSidebar">
                        <div class="fr-sidebar-close">
                            <h4>{{ __('Filters') }}</h4>
                            <button onclick="closeFrSidebar()" style="background:var(--gray-100);border:none;border-radius:50%;width:32px;height:32px;cursor:pointer;display:flex;align-items:center;justify-content:center;">
        ...
        window.closeFrSidebar = function () {
            const sidebar = document.getElementById('frSidebar');
            const overlay = document.getElementById('frOverlay');
        ...
        document.addEventListener('keydown', e => {
            if (e.key === 'Escape') window.closeFrSidebar();
        });
...
@push('styles')
    <style>
        ...
        @media (max-width: 1024px) {
            ...
            .fe-input-group-v2.border-start {
                border-left: 0;
            ...
            .fe-search-btn-v2::after {
                content: '{{ __("Search Flights") }}';
                font-size: 1rem;
                font-weight: 800;
            }
        }
        ...
        /* Mobile filter toggle bar (shown in results) */
        .fr-mobile-bar {
            display: none;
            align-items: center;
            justify-content: space-between;
        ...
        @media (max-width: 1023px) {
            ...
            /* Hide sidebar from layout flow on mobile (it's a drawer) */
            .fr-sidebar {
                display: none;
            }
        }
        ...
        @media (max-width: 1023px) {
            ...
            /* Add close button area for sidebar on mobile */
            .fr-sidebar-close {
                display: flex;
                justify-content: space-between;
                align-items: center;
        ...
        .fr-check input:checked+.fr-checkmark {
            border-color: var(--primary);
            background: var(--primary);
        }

        .fr-check input:checked+.fr-checkmark::after {
            content: "\f00c";
