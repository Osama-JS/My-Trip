...
<style>
/* ══════════════════════════════════════════════
   AGENT TRIP SHOW — PREMIUM DESIGN
   Uses layout CSS variables for dark mode support
   ══════════════════════════════════════════════ */

.ashow-container { max-width: 1100px; margin: 0 auto; }
...
.ashow-hero-title { font-size: 1.5rem; font-weight: 900; margin: 0 0 6px; color: #fff; }
.ashow-hero-breadcrumb { font-size: 0.85rem; color: rgba(255,255,255,0.7); }
.ashow-hero-breadcrumb a { color: rgba(255,255,255,0.7); text-decoration: none; }
.ashow-hero-breadcrumb a:hover { color: #fff; }

.ashow-hero-actions { display: flex; gap: 10px; flex-shrink: 0; flex-wrap: wrap; }
.ashow-hero-btn {
    padding: 10px 22px;
...
.ashow-hero-btn-edit { background: rgba(255,255,255,0.15); color: #fff; backdrop-filter: blur(10px); }
.ashow-hero-btn-edit:hover { background: rgba(255,255,255,0.25); transform: translateY(-2px); }
.ashow-hero-status {
    padding: 6px 16px;
    border-radius: 20px;
    font-size: 0.8rem;
...
.ashow-route-city { text-align: center; }
.ashow-route-city h6 { font-size: 1.15rem; font-weight: 800; color: #fff; margin: 0; }
.ashow-route-city small { font-size: 0.78rem; color: rgba(255,255,255,0.7); font-weight: 600; }
.ashow-route-line {
    flex: 1;
    height: 2px;
...
.ashow-section:hover { box-shadow: var(--shadow-md); }

.ashow-section-header {
    padding: 20px 28px;
...
.ashow-section:hover .s-icon { background: var(--accent); color: #fff; }
.ashow-section-header .s-badge {
...
.ashow-section-body { padding: 24px 28px; }
...
.ashow-info-item:hover { border-color: var(--border); transform: translateY(-2px); box-shadow: var(--shadow-sm); }
.ashow-info-label {
    font-size: 0.72rem;
    font-weight: 800;
    color: var(--text-muted);
...
.ashow-info-label i { font-size: 0.68rem; color: var(--accent); }
.ashow-info-value { font-size: 1.05rem; font-weight: 700; color: var(--text-primary); }
.ashow-info-accent { color: var(--accent); }
...
<div class="ashow-container">
    ...
    <div class="ashow-hero">
        <div class="ashow-hero-top">
            ...
            <div class="ashow-hero-actions">
                ...
                <a href="{{ route('agent.trips.edit', $trip->id) }}" class="ashow-hero-btn ashow-hero-btn-edit">
    ...
    <div class="ashow-section">
        <div class="ashow-section-header">
            <h5><span class="s-icon"><i class="fas fa-ticket-alt"></i></span>{{ __('Bookings') }}</h5>
            <span class="s-badge">{{ $trip->bookings->count() }} {{ __('Total') }}</span>
        </div>
        <div class="ashow-table-wrap">
            @if($trip->bookings->isEmpty())
                <div class="ashow-empty">
                    <i class="fas fa-ticket-alt"></i>
                    <p>{{ __('No bookings yet for this trip.') }}</p>
                </div>
            @else
        ...
        <div style="padding:22px;">
            <form id="editItinForm">
                ...
                <div style="display:flex; gap:10px; margin-top:4px;">
                    <button type="button" onclick="closeEditModal()" style="flex:1; padding:12px; border:1.5px solid var(--border); border-radius:var(--radius-md); background:var(--bg-body); color:var(--text-secondary); font-weight:700; cursor:pointer; font-size:.88rem; transition:all .2s; font-family:inherit;">
                        {{ __('Cancel') }}
                    </button>
                    <button type="submit" class="ashow-btn-add-day" style="flex:2; margin-top:0;">
