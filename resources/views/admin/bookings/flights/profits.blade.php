...
@section('title', __('Flight Profits Report'))

@section('page-header')
<div class="row page-titles">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.bookings.flights.index') }}">{{ __('Flight Bookings') }}</a></li>
        <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Flight Profits Report') }}</a></li>
    </ol>
</div>
@endsection
...
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.bookings.flights.profits') }}" method="GET">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('admin.bookings.flights.profits') }}" class="btn btn-danger light px-4"><i class="fas fa-sync me-2"></i>{{ __('Reset') }}</a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <div class="card">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    <h4 class="fs-16 mb-1">{{ __('Total Platform Profit (Flights)') }}</h4>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('#profits-table').DataTable({
            processing: true,
            serverSide: false,
            ajax: "{{ route('admin.bookings.flights.profits.data') }}" + qs,
            columns: [
                { data: 'id' },
                { data: 'reference' },
                { data: 'customer' },
