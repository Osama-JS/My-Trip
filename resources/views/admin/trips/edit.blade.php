...
<div class="container-fluid">
    <form action="{{ route('admin.trips.update', $trip->id) }}" method="POST" id="editTripsForm">
            ...
            <div class="card-body premium-card-body">
                <div class="tab-content" id="tripTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                        <div class="row">
                            <div class="col-md-6">
                                <x-forms.input-text name="title_ar" :label="__('Trip Title (AR)')" :value="$trip->title_ar" required icon="fa fa-pen" />
                            </div>
                            <div class="col-md-6">
                                <x-forms.input-text name="title_en" :label="__('Trip Title (EN)')" :value="$trip->title_en" required icon="fa fa-pen" />
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea id="description_ar" name="description_ar" class="form-control" rows="6">{!! $trip->description_ar !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label font-w600">{{ __('Description (en)') }} <span class="text-danger">*</span></label>
                                    <textarea id="description_en" name="description_en" class="form-control" rows="6">{!! $trip->description_en !!}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="includes_ar" name="includes_ar" class="form-control" rows="4">{!! $trip->includes_ar !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label font-w600">{{ __('Includes (EN)') }}</label>
                                    <textarea id="includes_en" name="includes_en" class="form-control" rows="4">{!! $trip->includes_en !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label font-w600">{{ __('Excludes (AR)') }}</label>
                                    <textarea id="excludes_ar" name="excludes_ar" class="form-control" rows="4">{!! $trip->excludes_ar !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label font-w600">{{ __('Excludes (EN)') }}</label>
                                    <textarea id="excludes_en" name="excludes_en" class="form-control" rows="4">{!! $trip->excludes_en !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label font-w600">{{ __('Children Policy (AR)') }}</label>
                                    <textarea id="children_policy_ar" name="children_policy_ar" class="form-control" rows="4">{!! $trip->children_policy_ar !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label font-w600">{{ __('Children Policy (EN)') }}</label>
                                    <textarea id="children_policy_en" name="children_policy_en" class="form-control" rows="4">{!! $trip->children_policy_en !!}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="pricing" role="tabpanel" aria-labelledby="pricing-tab">
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <x-forms.input-text name="price" :label="__('Base Price')" :value="$trip->price" icon="fa fa-dollar-sign" />
                            </div>
                            <div class="col-md-4 col-sm-6">
        ...
        <div class="sticky-action-bar">
            <button type="button" class="btn btn-light rounded-pill px-4 shadow-sm fw-bold" onclick="window.location.href='{{ route('admin.trips.index') }}'">{{ __('Cancel') }}</button>
            <button type="submit" class="btn btn-primary rounded-pill px-5 shadow-sm fw-bold"><i class="fas fa-save me-2"></i>{{ __('Update Trip') }}</button>
        </div>
    </form>
</div>
@endsection
