                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea id="description_ar" name="description_ar" class="form-control" rows="10">{!! $trip->description_ar !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label class="form-label font-w600">{{ __('Description (en)') }} <span class="text-danger">*</span></label>
                                            <textarea id="description_en" name="description_en" class="form-control" rows="10">{!! $trip->description_en !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
