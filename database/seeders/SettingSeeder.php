...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            'about_story_title_en' => 'The Story of My-Trip',
            'about_story_title_ar' => 'قصة My-Trip',
            'about_story_desc_1_en' => 'My-Trip started with a simple idea: to make premium travel accessible to everyone. We noticed a gap in the market for a truly personalized, high-quality booking experience that caters to modern travelers.',
            'about_story_desc_1_ar' => 'بدأت My-Trip بفكرة بسيطة: جعل السفر الفاخر في متناول الجميع. لقد لاحظنا وجود فجوة في السوق لتجربة حجز مخصصة وعالية الجودة حقاً تلبي احتياجات المسافرين العصريين.',
