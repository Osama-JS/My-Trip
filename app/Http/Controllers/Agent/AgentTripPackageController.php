...
class AgentTripPackageController extends Controller
{
    /**
     ...
     */
    public function update(Request $request, TripPackage $package)
    {
        $trip = $package->trip;
        $this->authorizeAgent($trip);
     ...
     * Delete a package.
     */
    public function destroy(TripPackage $package)
    {
        $trip = $package->trip;
        $this->authorizeAgent($trip);
